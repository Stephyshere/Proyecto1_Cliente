...
function calcularInteraccion(accion, gato) {
    ...
    switch(accion) {
        ...
        case 'acariciar':
            ...
            } else { dAfecto = 10; img = IMAGENES.mimos_ok; texto = "Purrrr... mimos."; } break;
        case 'jugarConLaser': dSalud = -2; dAfecto = 15; img = IMAGENES.laser; texto = "¡Atrápalo! 🔴"; break;
        case 'caja': dAfecto = 20; img = IMAGENES.caja; texto = "Si encajo, me siento. 📦"; break;
        case 'lavar':
            if (r > 0.7) { dSalud = 15; img = IMAGENES.bano_ok; texto = "Estoy limpio ✨"; } 
            else { dAfecto = -20; img = IMAGENES.bano_bad; texto = "¡ODIO EL AGUA! 💦"; } break;
        case 'medicina': 
            if (gato.salud < 100) {
                if (r > 0.4) { dSalud = 50; dAfecto = 5; img = IMAGENES.curar_ok; texto = "Me siento mejor."; } 
                else { dSalud = 30; dAfecto = -5; img = IMAGENES.curar_bad; texto = "¡Sabe a rayos!"; }
            } else { dAfecto = -5; img = IMAGENES.curar_bad; texto = "¡No estoy enfermo!"; } break;
        case 'ignorar': dAfecto = -10; img = IMAGENES.ignorar; texto = "Esperando..."; break;
        case 'asustar': dSalud = -5; dAfecto = -15; img = IMAGENES.asustar; texto = "¡AAAAH! 👻"; break;
        case 'cepillar': dAfecto = 8; img = IMAGENES.cepillar; texto = "Qué suave..."; break;
    }
